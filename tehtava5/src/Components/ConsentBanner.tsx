...
export default function ConsentBanner() {
  ...
  return (
    <div style={{
      ...
      backgroundColor: "#f5f5f5", borderTop: "1px solid #ccc", zIndex: 1000,
    }}>
      <p style={{ marginBottom: "0.5rem", color: "#333" }}>
        Tämä sovellus käyttää anonyymia analytiikkaa sovelluksen teknisen toimivuuden arviointiin.
      </p>
      <button onClick={acceptAnalytics} style={{ marginRight: "0.5rem" }}>Hyväksy analytiikka</button>
